...
;
const najotLogo = "/assets/logo.jpg";

export default function StudentLessonDetail() {
    const [isSidebarOpen, setIsSidebarOpen] = useState(false);
    const params = useParams(); const id = params?.id as string; const lessonId = params?.lessonId as string;
    ...
    const mockTopics = [
        { 
            ...
            homeworkDetails: {
                ...
                task: {
                    title: 'Uyga vazifa',
                    deadline: 'Uyga vazifa muddati: 16 May, 2026 18:42',
                ...
                submission: {
                    title: "Mening jo'natmalarim",
                    fileCount: 0,
                    links: [
                        'https://6a08a17f6f27521adf2b6f3c--incredible-paprenjak-5441d6.netlify.app/',
                        'https://github.com/xdislom/7-oy-imtihon'
                    ],
                    date: '21:56 16 May, 2026',
                    status: 'Tahrirlangan'
                },
                feedback: {
                    title: "O'qituvchi izohi",
                    status: 'Vazifa bekor qilindi',
                    ...
                    checker: "Muxammedaliy +++Ametov",
                    date: '14:02 19 May, 2026'
                }
            }
        },
        { 
            ...
            homeworkDetails: {
                ...
                task: {
                    title: 'Uyga vazifa',
                    deadline: 'Uyga vazifa muddati: 14 May, 2026 15:54',
                    deadlineStatus: 'danger',
                    fileCount: 0,
                ...
                submission: {
                    ...
                    fileCount: 0,
                    links: [
                        'https://github.com/xdislom/7-oy-imtihon/tree/main',
                        'https://69ff6564c5d71ba3ee0a7861--courageous-malabi-b7c4ce.netlify.app/'
                    ],
                    date: '16:08 12 May, 2026',
                },
                feedback: {
                    title: "O'qituvchi izohi",
                    status: 'Vazifa qabul qilindi',
                    comment: "Vazifa yaxshi bajarilgan )",
                    checker: "Muxammedaliy +++Ametov",
                    date: '11:16 15 May, 2026'
                },
        ...
        { 
            ...
            date: '2026 M05 21', 
            videos: [
                { id: 3, title: 'State and Props', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
            ],
            hwStatus: 'Berilmagan'
        },
        { 
            ...
            date: '2026 M05 19', 
            videos: [
                { id: 4, title: 'takrorlash darsi', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
            ],
            hwStatus: 'Bajarilmagan',
            homeworkDetails: {
                task: {
                    title: 'Uyga vazifa',
                    deadline: 'Uyga vazifa muddati: 14 Iyun, 2026 17:31',
        ...
        { 
            ...
            date: '2026 M05 14', 
            videos: [
                { id: 5, title: 'Nodejs Kirish', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
            ],
            hwStatus: 'Qabul qilingan',
            homeworkDetails: {
                score: 90,
        ...
        { 
            ...
            date: '2026 M05 12', 
            videos: [
                { id: 6, title: 'HTML dars', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
            ],
            hwStatus: 'Qaytarilgan',
            homeworkDetails: {
                score: 0,
    ...
    const [activeTopicId, setActiveTopicId] = useState(parseInt(lessonId) || mockTopics[0].id);
    ...
    const handleVideoClick = (e, topicId, video) => {
        e.stopPropagation();
            ...
            <div className="flex">
                ...
                <div className="flex-1 min-h-screen flex flex-col transition-all duration-300 w-full overflow-hidden">
                    ...
                    <div className="p-[20px] md:p-[30px] flex flex-col lg:flex-row gap-6">
                        ...
                        {/* Left Main Content */}
                        <div className="flex-1 flex flex-col gap-4 overflow-y-auto pr-2 custom-scroll" style={{ maxHeight: 'calc(100vh - 120px)' }}>
                            {/* Video Player Area */}
                            <div className="bg-white rounded-[12px] shadow-sm flex flex-col overflow-hidden relative" style={{ minHeight: '400px' }}>
                                {activeVideo ? (
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center p-10 bg-white">
                                        <div className="w-[120px] mb-6 opacity-30">
                                            <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M50 20 L80 40 L50 60 L20 40 Z" stroke="#c6a27a" strokeWidth="4" strokeLinejoin="round"/>
                                                <path d="M20 60 L50 80 L80 60" stroke="#c6a27a" strokeWidth="4" strokeLinejoin="round"/>
                                                <path d="M50 20 L50 80" stroke="#c6a27a" strokeWidth="4" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                            ...
                            {/* Tabs */}
                            <div className="bg-white rounded-[12px] shadow-sm flex flex-col shrink-0" style={{ minHeight: '300px' }}>
                                <div className="flex border-b border-gray-100 px-2 shrink-0 justify-between items-center">
                                    <div className="flex">
                                        <button 
                                            className={`px-6 py-4 text-[15px] font-medium transition-colors relative ${activeTab === 'Vazifalar' ? 'text-[#c6a27a]' : 'text-gray-500 hover:text-gray-700'}`}
                                    ...
                                    {activeTab === 'Vazifalar' && activeTopic.homeworkDetails && activeTopic.homeworkDetails.score !== undefined && (
                                            ...
                                            <div className="flex flex-col gap-4">
                                                ...
                                                <div className="bg-[#fcfaf8] rounded-[12px] p-6 shadow-[0_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col relative">
                                                    <div className="flex justify-between items-start mb-6">
                                                        <h3 className="text-[18px] font-[500] text-gray-800">{activeTopic.homeworkDetails.task.title}</h3>
                                                        ...
                                                        <span className="text-gray-600 text-[14px]">Fayllar soni: {activeTopic.homeworkDetails.task.fileCount}</span>
                                                    </div>
                                                    ...
                                                    {activeTopic.homeworkDetails.task.attachment && (
                                                        <div className="mt-6">
                                                            <div className="inline-flex items-center gap-3 bg-white border border-gray-100 rounded-[8px] p-4 shadow-sm w-full max-w-[300px] hover:shadow-md transition-shadow cursor-pointer">
                                                                ...
                                                                <span className="text-gray-700 text-[14px] font-medium">{activeTopic.homeworkDetails.task.attachment.name}</span>
                                                            </div>
                                                        </div>
                                                    )}
                                                ...
                                                {activeTopic.homeworkDetails.submission && (
                                                    <div className="bg-[#fcfaf8] rounded-[12px] p-6 shadow-[0_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col">
                                                        <div className="flex justify-between items-start mb-4">
                                                            <h3 className="text-[18px] font-[500] text-gray-800">{activeTopic.homeworkDetails.submission.title}</h3>
                                                            <span className="text-gray-600 text-[14px]">Fayllar soni: {activeTopic.homeworkDetails.submission.fileCount}</span>
                                                        </div>
                                                        <div className="flex flex-col gap-3 mt-2">
                                                            {activeTopic.homeworkDetails.submission.links.map((link, idx) => (
                                                                <a key={idx} href={link} target="_blank" rel="noreferrer" className="text-gray-800 hover:text-blue-600 transition-colors text-[14px] truncate">
                                                                    {link}
                                                                </a>
                                                            ))}
                                                        </div>
                                                        <div className="flex flex-col items-end mt-6 gap-2">
                                                            <span className="text-gray-500 text-[14px]">{activeTopic.homeworkDetails.submission.date}</span>
                                                ...
                                                {activeTopic.homeworkDetails.feedback && (
                                                    <div className="bg-[#fcfaf8] rounded-[12px] p-6 shadow-[0_1px_3px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col">
                                                        <div className="flex justify-between items-start">
                                                            <h3 className="text-[16px] font-[500] text-gray-800">{activeTopic.homeworkDetails.feedback.title}</h3>
                                                            <span className={`text-[14px] font-medium ${activeTopic.homeworkDetails.feedback.status === 'Vazifa qabul qilindi' ? 'text-green-600' : 'text-[#f04445]'}`}>
                                                    ...
                                                    <div className="flex flex-col gap-2 mt-4">
                                                        {selectedFile && (
                                                            <div className="flex items-center gap-2 bg-white border border-gray-100 rounded-[8px] px-4 py-2.5 shadow-sm w-fit">
                                                                ...
                                                                <span className="text-gray-700 text-[13px] font-medium">{selectedFile.name}</span>
                                                                <button 
                        ...
                        <div className="w-full lg:w-[320px] shrink-0 flex flex-col gap-4 overflow-y-auto pr-2" style={{ maxHeight: 'calc(100vh - 120px)' }}>
                                                ...
                                                {topic.videos.map((video, idx) => (
                                                    <div 
                                                        ...
                                                        className={`
                                                            ...
                                                            ${activeVideo?.id === video.id ? 'bg-[#fff] border border-[#c6a27a] shadow-sm' : 'hover:bg-[#f3f4f6]'}
                                                        `}
                                                    >
                                                        <div className="w-[30px] h-[30px] rounded-full bg-gray-100 flex items-center justify-center shrink-0">
                                                            <i className={`fa-solid fa-play text-[10px] ${activeVideo?.id === video.id ? 'text-[#c6a27a]' : 'text-gray-400'}`}></i>
                                                        </div>
                                                        <span className={`text-[14px] font-medium ${activeVideo?.id === video.id ? 'text-[#c6a27a]' : 'text-gray-700'}`}>
                                                            {idx + 1}. {video.title}
                                                        </span>
                                                    </div>
                                                ))}
