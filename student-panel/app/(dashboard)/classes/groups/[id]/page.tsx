...
export default function GroupDetail() {
    ...
    useEffect(() => {
        if (pathname.startsWith("/dashboard/groups/")) {
            router.push(`/classes/groups/${groupId}`, { replace: true })
            return
        }
                                        ...
                                        <button
                                            onClick={() => {
                                                if (activeLessonsTab === 'homework') {
                                                    router.push(`${pathname}/homework/create`)
                                                } else {
                                                    ...
                                                    <tbody>
                                                        {lessons.map((lesson, index) => {
                                                            ...
                                                            return (
                                                                <tr 
                                                                    key={lesson.id || index} 
                                                                    onClick={() => router.push(`${pathname}/homework/${actualHomeworkId}/results`, { state: { lesson } })}
                                ...
                                {activeLessonsTab === "exams" && (
                                    <div className="animate-fade-in">
                                        <div className="flex justify-end mb-[20px]">
                                            <button 
                                                onClick={() => router.push(`${pathname}/exams/create`)}
                                            ...
                                            <table className="w-full min-w-[900px]">
                                                ...
                                                <tbody>
                                                    {[
                                                        ...
                                                        <tr 
                                                            key={exam.id} 
                                                            onClick={() => router.push(`${pathname}/exams/${exam.id}`)}
