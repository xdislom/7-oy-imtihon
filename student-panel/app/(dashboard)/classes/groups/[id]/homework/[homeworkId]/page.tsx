...
export default function HomeworkCheck() {
    const params = useParams(); const groupId = params?.id as string; const homeworkId = params?.homeworkId as string; const studentId = params?.studentId as string
    ...
    const goBack = () => {
        const base = pathname.includes('/dashboard') ? '/dashboard' : '/classes'
        router.push(`${base}/groups/${groupId}/homework/${homeworkId}/results`, {
            state: { lesson }
        })
    }
