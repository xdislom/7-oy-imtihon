...
export default function Sidebar({ isOpen, onClose }: Props) {
  ...
  const handleBoshqarishClick = (e: React.MouseEvent) => {
    e.preventDefault();
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`h-full p-[20px] flex flex-col justify-between border-r border-gray-100 bg-white z-[102] w-full overflow-hidden`}
        >
          <ul className="list-none p-0 m-0">
            ...
            >
              <div className="flex items-center">
                ...
                />
                {!isCollapsed && (
                  <li className="text-[24px] text-purple-500 font-[500] pt-[7px] ml-2">
                    NajotEdu
                  </li>
                )}
              </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`text-[20px] font-[500] rounded-[10px] mt-[15px] flex items-center gap-[10px] h-[50px] cursor-pointer transition-colors duration-200 no-underline ${
                    ...
                    item.to === "/settings" && isSubmenuOpen
                      ? "bg-purple-600 text-white"
                      : ""
                  }`}
                >
            ...
            <div className="w-full rounded-[16px] p-[16px] subscription-card border border-gray-200 dark:border-zinc-800 mt-4">
              <div className="flex items-center gap-[12px] mb-[12px]">
                ...
                <div className="flex flex-col">
                  <span className="text-[15px] font-[700] text-black leading-tight">
                    Obuna
                  </span>
                  <span className="text-[#ef4444] text-[13px] font-[500] mt-0.5 leading-tight">
                    Obunangiz tugagan
                  </span>
                </div>
              </div>
        ...
        <div
          ...
          `}
        >
          <p className="text-gray-400 text-[13px] font-[600] uppercase tracking-wider mb-2 px-[15px]">
            Menu
          </p>
          ...
          <ul className="list-none p-0 m-0">
            {settingsSubmenu.map((item) => (
              <Link
                ...
                className={`flex items-center gap-[12px] text-[16px] font-[500] px-[15px] py-[12px] rounded-[10px] mt-[6px] cursor-pointer transition-colors duration-200 no-underline ${
