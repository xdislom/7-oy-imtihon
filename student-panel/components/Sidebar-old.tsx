                            ...
                            <Link
                                ...
                                className={({ isActive }) =>
                                    `flex items-center gap-[12px] text-[16px] font-[500] px-[15px] py-[12px] rounded-[10px] mt-[6px] cursor-pointer transition-colors duration-200 no-underline ${
                                        pathname === "/settings" && searchParams.toString().includes(item.tab)
                                            ? "bg-purple-100 text-purple-700"
                                            : "text-gray-700 hover:bg-purple-50 hover:text-purple-600"
                                    }`
                                }
                            >
                                <i className={`${item.icon} ${pathname === "/settings" && searchParams.toString().includes(item.tab) ? 'text-purple-600' : 'text-purple-400'} w-[20px] text-center`}></i>
                                {item.label}
                            </Link>
                        ))}
                    </ul>
